    ...
    <div className='w-full flex items-center justify-between h-20 px-3'>
      ...
      <div className='w-6/12 flex items-center space-x-4'>
        <div className='w-3/4 flex items-center'>
          <input onKeyPress={onKeyFun} value={searchKeyword} onChange={e => setSearchKeyword(e.target.value)} className='outline-none border p-2 h-10 flex-1' type="text" placeholder='Ara' />
